...
class DemoProgram(Program):
    def init_train_params(self):
        ...
        self.train_params['optimizer'] = ['Optimizer', 'Adam', 'choices', None, None, None, ['Adam(Adaptive Moment Estimation)', 'RMSProp (Root Mean Squared Propagation)', 'SGD(Stochastic gradient descent)']]
        self.train_params['num_of_classes'] = ['Number of classes', 5, 'int', 2, 9999999]
        self.train_params['pretrained_weight/csv'] = ['Pretrained weight/csv', r'D:/model/pretrained/weight.h5', 'file']
